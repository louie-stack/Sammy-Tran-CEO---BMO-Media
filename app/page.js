  ...
  return (
    <div style={{ ...IN, background: "#0D0D0D", minHeight: "100vh", color: "#fff" }}>
      ...
      <section style={{ paddingTop: 54, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: "100px 40px 72px", display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 24, position: "relative", zIndex: 1 }}>
          <div>
